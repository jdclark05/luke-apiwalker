        ...
        <div className="cardMain2">
            {props.planetData.map((planet) => {
                if( isNaN(`${planet.population}`) ){
                    ...
                    return(
                    <div key={planet} className="personCardMain">
                    ...
                    return(
                        <div key={planet} className="personCardMain">
                            ...
                            <div className="population">
                                <p className="popText">Population: </p><p id="goldShadow3"><NumberFormat value={planet.population} className="foo" displayType={'text'} thousandSeparator={true}/></p>
                            </div>
                            <div className="climate">
                                <p className="climText">Climate: </p>
                                <div className="climFeatures">
